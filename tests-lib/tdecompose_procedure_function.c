...
int main(void) {
  ...
  res = sollya_lib_decompose_procedure_function(&f[4], &deriv, &f[5], f[3]);
  if (res) sollya_lib_printf("sollya_lib_decompose_procedure_function should not succeed on %b but it did.\n", f[3]);
  ...
  deriv = -1;
  res = sollya_lib_decompose_procedure_function(&f[6], &deriv, &f[7], f[5]);
  f[8] = SOLLYA_X_;
  ...
  if (!res) sollya_lib_printf("sollya_lib_decompose_procedure_function should succeed on %b. It did not.\n", f[5]);
  else {
  ...
  deriv = -1;
  res = sollya_lib_decompose_procedure_function(&f[18], &deriv, &f[19], f[17]);
  f[20] = SOLLYA_X_;
  ...
  deriv = -1;
  res = sollya_lib_decompose_procedure_function(&f[26], &deriv, &f[27], f[25]);
  f[28] = SOLLYA_X_;
