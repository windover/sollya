...
\phantom{aaa}keyword representing a \textsf{range} type \\[0.2cm]
\noindent Usage: 
\begin{center}
...
\end{itemize}
See also: \textbf{externalproc} (\ref{labexternalproc}), \textbf{boolean} (\ref{labboolean}), \textbf{constant} (\ref{labconstant}), \textbf{function} (\ref{labfunction}), \textbf{integer} (\ref{labinteger}), \textbf{list of} (\ref{lablistof}), \textbf{string} (\ref{labstring}), \textbf{object} (\ref{labobject})
