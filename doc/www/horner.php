...
<span class="category">See also: </span><?php linkTo("command","canonical","canonical");?>, <?php linkTo("command","print","print");?>, <?php linkTo("command","coeff","coeff");?>, <?php linkTo("command","degree","degree");?>, <?php linkTo("command","autosimplify","autosimplify");?>, <?php linkTo("command","simplify","simplify");?> 
</div> 
