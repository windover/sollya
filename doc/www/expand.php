...
<span class="category">See also: </span>$SIMPLIFY, <?php linkTo("command","simplifysafe","simplify");?>, <?php linkTo("command","horner","horner");?>, <?php linkTo("command","coeff","coeff");?>, <?php linkTo("command","degree","degree");?> 
</div> 
