...
<span class="commandline"><?php linkTo("command","searchgal","searchgal");?>(<span class="arg">function</span>, <span class="arg">start</span>, <span class="arg">preimage precision</span>, <span class="arg">steps</span>, <span class="arg">format</span>, <span class="arg">error bound</span>) : (<span class="type">function</span>, <span class="type">constant</span>, <span class="type">integer</span>, <span class="type">integer</span>, <span class="type">D|double|DD|doubledouble|DE|doubleextended|TD|tripledouble</span>, <span class="type">constant</span>) -&gt; <span class="type">list</span></span> 
