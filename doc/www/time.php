...
&nbsp;&nbsp;&nbsp;0.396980999999999999996135036095523673793650232255459 s were spent<br> 
</div> 
<div class="divExample"> 
<h2 class="category">Example 3: </h2> 
&nbsp;&nbsp;&nbsp;&gt; t = time(bashexecute("sleep 10"));<br> 
&nbsp;&nbsp;&nbsp;&gt; write(~(t-10),"s of execution overhead.\n");<br> 
&nbsp;&nbsp;&nbsp;2.27300000000000071431749404382571810856461524963379e-3s of execution overhead.<br> 
</div> 
<div class="divExample"> 
...
&nbsp;&nbsp;&nbsp;This ratio = 6.7470006631699523722549973086677762230493858183765 should somehow be independent of the type of machine.<br> 
</div> 
</div> 
