<a name="mult"></a> 
<div class="divName"> 
<h2 class="name">Name:</h2> <?php linkTo("command","mult","*");?> 
...
<span class="commandline"><span class="arg">interval1</span> <?php linkTo("command","mult","*");?> <span class="arg">interval2</span> : (<span class="type">range</span>, <span class="type">range</span>) -&gt; <span class="type">range</span></span> 
<span class="commandline"><span class="arg">interval1</span> <?php linkTo("command","mult","*");?> <span class="arg">constant</span> : (<span class="type">range</span>, <span class="type">constant</span>) -&gt; <span class="type">range</span></span> 
<span class="commandline"><span class="arg">interval1</span> <?php linkTo("command","mult","*");?> <span class="arg">constant</span> : (<span class="type">constant</span>, <span class="type">range</span>) -&gt; <span class="type">range</span></span> 
...
<li><?php linkTo("command","mult","*");?> represents the multiplication (function) on reals.  
The expression <span class="arg">function1</span> <?php linkTo("command","mult","*");?> <span class="arg">function2</span> stands for 
...
</li><li><?php linkTo("command","mult","*");?> can be used for interval arithmetic on intervals 
(ranges). <?php linkTo("command","mult","*");?> will evaluate to an interval that safely 
...
<span class="category">See also: </span><?php linkTo("command","plus","+");?>, <?php linkTo("command","minus","-");?>, <?php linkTo("command","divide","/");?>, <?php linkTo("command","power","^");?> 
</div> 
