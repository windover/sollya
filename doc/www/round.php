...
<span class="category">See also: </span><?php linkTo("command","rn","RN");?>, <?php linkTo("command","rd","RD");?>, <?php linkTo("command","ru","RU");?>, <?php linkTo("command","rz","RZ");?>, <?php linkTo("command","single","single");?>, <?php linkTo("command","double","double");?>, <?php linkTo("command","doubleextended","doubleextended");?>, <?php linkTo("command","doubledouble","doubledouble");?>, <?php linkTo("command","tripledouble","tripledouble");?>, <?php linkTo("command","roundcoefficients","roundcoefficients");?>, <?php linkTo("command","roundcorrectly","roundcorrectly");?>, <?php linkTo("command","printdouble","printdouble");?>, <?php linkTo("command","printsingle","printsingle");?>, <?php linkTo("command","ceil","ceil");?>, <?php linkTo("command","floor","floor");?>, <?php linkTo("command","nearestint","nearestint");?> 
</div> 
