<a name="string"></a> 
<div class="divName"> 
<h2 class="name">Name:</h2> <?php linkTo("command","string","string");?> 
...
<li><?php linkTo("command","string","string");?> represents the <span class="type">string</span> type for declarations 
...
<?php linkTo("command","string","string");?> cannot be handled outside the <?php linkTo("command","externalproc","externalproc");?> context.  In 
