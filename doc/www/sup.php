...
<span class="commandline type">sollya_obj_t sollya_lib_sup(sollya_obj_t)</span> 
</div> 
<div class="divUsage"> 
...
</li><li>When called on a real number <span class="arg">x</span>, <?php linkTo("command","sup","sup");?> behaves like the identity. 
</ul> 
</div> 
