...
<li><?php linkTo("command","rename","rename");?> permits a change of the name of the free variable. Sollya can handle only 
...
can be changed using <?php linkTo("command","rename","rename");?>. 
</li><li>Be careful: if <span class="arg">ident2</span> has been set before, its value will be lost. Use the  
command <?php linkTo("command","isbound","isbound");?> to know if <span class="arg">ident2</span> is already used or not. 
...
defined, <span class="arg">ident1</span> is just ignored and the name of the free variable is  
set to <span class="arg">ident2</span>. 
</ul> 
</div> 
