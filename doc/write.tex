...
\end{Verbatim}
\end{minipage}\end{center}
See also: \textbf{print}, \textbf{printexpansion}, \textbf{printhexa}, \textbf{printfloat}, \textbf{printxml}, \textbf{readfile}, \textbf{autosymplify}, \textbf{display}, \textbf{midpointmode}, \textbf{fullparentheses}, \textbf{evaluate}
