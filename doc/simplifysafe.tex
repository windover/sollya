...
\verb|   sollya_obj_t sollya_lib_simplifysafe(sollya_obj_t)|\\[0.2cm]
\noindent Usage: 
\begin{center}
...
\end{Verbatim}
\end{minipage}\end{center}
See also: $SIMPLIFY, \textbf{autosimplify} (\ref{labautosimplify}), \textbf{rationalmode} (\ref{labrationalmode}), \textbf{horner} (\ref{labhorner})
