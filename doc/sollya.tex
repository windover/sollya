...
\author{Sylvain Chevillard \\ \small{\url{sylvain.chevillard@ens-lyon.org}} \and Christoph Lauter \\ \small{\url{christoph.lauter@ens-lyon.org}} \and Mioara Joldes \\ \small{\url{mioara.joldes@ens-lyon.fr}} }
...
Let's think about infinities first:
\input{introExample32}

and now let's think about NaNs:
\input{introExample33}

\subsection{Rational numbers and rational arithmetic}

TODO Add section on rational arithmetic supported when enabled by the user (rationalmode = on).


\subsection{Intervals and interval arithmetic}

TODO Add paragraph on interval arithmetic supported natively.
TODO Add paragraph on thin intervals defined by one number [x], including their displaying in midpointmode.
