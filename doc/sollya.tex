...
Remark that the \com{mid} operator never provokes a rounding. If a
rounding were needed, it is rewritten as an unevaluated expression in
terms of \com{inf} and \com{sup}.
