...
\begin{tabular}{|l|p{7cm}|}
  ...
  \verb|SOLLYA_FP_FAITHFUL_PROVEN_EXACT| & The algorithm ended up at step (a) and $I$ was equal to $[x,x]$ where $x$ was a finite floating-point number at precision~$q$.\\[0.3cm]
