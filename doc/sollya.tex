...
\begin{itemize}
\item \verb|int sollya_lib_decompose_library_function(void **f, int *deriv, sollya_obj_t *e,|\\
\phantom{\texttt{int sollya\_lib\_decompose\_library\_function( }}\verb|sollya_obj_t g)|:\\ assume that \verb|g| represents an expression $f_0(f_1)$ where $f_0$ is a library function. Then, $f_0$ is the $n$-th derivative (for some $n$) of a function provided within Sollya via an external C function \verb|int func(mpfi_t, mpfi_t, int)|.\\
...
\phantom{\texttt{int sollya\_lib\_decompose\_procedure\_function( }}\verb|sollya_obj_t *e, sollya_obj_t g)|:\\
