...
\title{Users' manual for the \sollya tool \\ {\large 4.0-ReleaseCandidate}}

\author{Sylvain Chevillard \\ \small{\url{sylvain.chevillard@ens-lyon.org}} \and Christoph Lauter \\ \small{\url{christoph.lauter@ens-lyon.org}} \and Mioara Jolde\c{s} \\ \small{\url{joldes@lass.fr}} }
...
assume that \verb|c| is a constant provided via an external C function \verb|void func(mpfr_t, mp_prec_t)|. As a result of a call to \verb|sollya_lib_decompose_libraryconstant|, a pointer to \verb|func| is stored at the addresse referred to by \verb|f| and a boolean integer representing true is returned. Otherwise, nothing happens and false is returned.
\end{itemize}
