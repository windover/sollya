...
pattern is found, display an error warning and return \key{error}.
...
\item For lists that are end-elliptic, i.e. prolongated to infinity,
  the \key{@} operator does not work for cases that would imply the
...
the pattern in the corresponding element of the structure pattern {\it
  sp}. The user should be aware that fact that the structure to be
