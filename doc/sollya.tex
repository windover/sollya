...
\phantom{\texttt{int sollya\_lib\_decompose\_library\_function( }}\verb|int *deriv, sollya_obj_t *e,|\\
...
\phantom{\texttt{int sollya\_lib\_decompose\_library\_constant( }}\verb|sollya_obj_t c)|:\\
