...
\item \com{arenaireplot} comprend aussi des opérateurs fonctionnels
  ...
  \begin{itemize}
    ...
    \item Il est possible de lier des fonctions implémentés en \com{MPFI} à
      l'exterieur d'\com{arenaireplot} à des symboles de
      fonction. Dans la suite, il est possible d'utiliser ces
      fonctions comme les fonctions prédéfinies comme \com{exp} ou
