...
Les affectations de variables, y compris la définition du nom de la
variable libre globale, peuvent être mises à zero par la commande
\com{restart}. Cette commande mettra également aux valeurs par défaut
la précision, le nombre de points, le nombre de récursions pour
l'évaluation par Taylor, l'affichage dyadique et la verbosité.
