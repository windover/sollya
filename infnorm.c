  ...
  case DIV:
	...
	if (mpfr_cmp(xl,xr) != 0) {
	  ...
	  if (mpfr_number_p(z)) {
	    ...
	    t1 = evaluateI(numeratorInZI, tree->child1, zI, prec, simplifiesA, simplifiesB-1, NULL, leftTheoConstant);
	    t2 = evaluateI(denominatorInZI, tree->child2, zI, prec, simplifiesA, simplifiesB-1, NULL, rightTheoConstant);
