tools: parser.tab.o lex.yy.o plot.o expression.o infnorm.o remez.o main.o chain.o
	gcc -Wall -g -o tools lex.yy.o plot.o parser.tab.o expression.o infnorm.o remez.o chain.o main.o -lfl -lmpfr -lgmp -lmpfi
